...
void CAlliance::addParty(CParty* party)
{
    ...
    {
        party->ReloadTreasurePool(dynamic_cast<CCharEntity*>(party->members.at(i)));
        charutils::SaveCharStats(dynamic_cast<CCharEntity*>(party->members.at(i)));
    }
...
void CAlliance::pushParty(CParty* PParty, uint8 number)
{
    ...
    {
        PParty->ReloadTreasurePool(dynamic_cast<CCharEntity*>(PParty->members.at(i)));
        charutils::SaveCharStats(dynamic_cast<CCharEntity*>(PParty->members.at(i)));
    }
}
