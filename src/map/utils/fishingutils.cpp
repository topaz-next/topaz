...
void StartFishing(CCharEntity* PChar)
{
    ...
    WeaponItem = dynamic_cast<CItemWeapon*>(PChar->getEquip(SLOT_RANGED));
    ...
    WeaponItem = dynamic_cast<CItemWeapon*>(PChar->getEquip(SLOT_AMMO));
...
{
    CItemWeapon* PLure = dynamic_cast<CItemWeapon*>(PChar->getEquip(SLOT_AMMO));
