...
function onSpellCast(caster, target, spell)
    ...
    caster:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 6, 3, 180, tpz.effect.GEO_REFRESH, power, tpz.auraTarget.ALLIES, tpz.effectFlag.AURA)
